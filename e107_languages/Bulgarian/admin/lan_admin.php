...
define("ADLAN_154", "Грешка при опит за контакт с e107.org за проверка на нова версия");
...
define("ADLAN_ERR_3", "Намерени са един или повече файла във вашите директории за публично качване, които не присъстват в списъка с позволени файлове. Възможно е това да е опит за атака на вашия сървър и в такъв случай е необходимо <b>незабавното им изтриване</b>. <b>Не трябва да отваряте</b> тези файлове, тъй като е възможно по този начин да стартирате потенциално опасен код; НЕ отваряйте тези файлове с браузър.<br /><br />В случай, че разпознаете тези файлове като легитимни, е възможно скоро да сте правили промени в списъка на допустимите файлове за качване и този тип файлове да не присъства вече в този списък. Добавете този тип файлове в списъка (виж Администрация => Публично качване на файл). Поради мерки за сигурност не би трябвало да позволявате качването на файлове от тип .html, .txt и т.н. - по този начин е възможно качването на потенциално опасен javascript. Разбира се в никакъв случай не би трябвало да позволявате и качване на файлове .php или какъвто и да е друг тип изпълним скрипт.<br /><br />Следва списък с намерените потенциално опасни файлове:");
...
define("ADLAN_ERR_7", "Открити са зловредни файлове на Вашият сървър. Те трябва да бъдат премахнати [b]незабавно[/b].");
define("ADLAN_ERR_8", "Моля стартирайте [Файл инспектора], за да проверите дали са променени файлове на ядрото.");
...
define("LAN_NEWVERSION_MORE", "научи повече");
define("LAN_NEWVERSION_DLD", "Изтегляне %s от SF.net");
define("LAN_NEWVERSION_CHECK_ERROR", "Грешка при проверка за нова версия");
define("LAN_SECURITYL_0", "Търсите си проблеми ( няма защита )");
define("LAN_SECURITYL_5", "Балансирана");
define("LAN_SECURITYL_8", "Висока");
