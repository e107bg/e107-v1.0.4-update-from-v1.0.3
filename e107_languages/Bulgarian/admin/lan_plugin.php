...
define("EPL_ADLAN_19", "Таблиците са създадени успешно в базата данни.");
...
define("EPL_ADLAN_43", "Модула бе качен и разархивиран, моля потърсете го в списъка с модули.");
...
define("EPL_ADLAN_45", "Менюто е качено и разархивирано, за да го активирате идете в <a href='".e_ADMIN."menus.php'>страницата на менютата</a>.");
...
define("EPL_ADLAN_58", "Ако таблиците не се изтрият, модула може да се инсталира отново без загуба на данни. При нова инсталация създаването на таблиците няма да бъде успешно. Таблиците ще трябва да се премахнат ръчно.");
...
define("EPL_ADLAN_64", "Всички файлове са премахнати от");
define("EPL_ADLAN_65", "Изтриването на файловете  е неуспешно");
