...
define("UPLLAN_35", "Разрешени типове файлове");
define("UPLLAN_36", "Моля въведете по един вид на ред");
define("UPLLAN_37", "Права");
define("UPLLAN_38", "Избор на потребители, имащи право да качват файлове");
define("UPLLAN_39", "Запис");
define("UPLLAN_41", "Внимание - качване на файлове е забранено от php.ini. Невъзможно е качване на файлове. Променете php.ini настройките и опитайте пак.");
...
и добавете в него списък разделен със запетаи с позволените разширения. Не би трябвало да позволявате качване на файлове с разширения .html, .txt, и т.н., поради риск от вмъкване на опасен javascript код от хора атакуващи вашия сайт. Разбира се, не би трябвало да позволите 
